...
public class BasicTests extends ActivityInstrumentationTestCase2<MenuActivity> {
    ...
    public void testJoinChannel() throws Exception {
        ...
        solo.assertCurrentActivity("Expected MenuActivity activity", "MenuActivity");
        solo.clearEditText(0);
        solo.enterText(0, AUTO_TEST_CHANNEL_NAME);
        solo.waitForText(AUTO_TEST_CHANNEL_NAME, 1, 2000L);

        solo.clickOnView(solo.getView(com.longlongago.openvcall.R.id.button_join_room));
