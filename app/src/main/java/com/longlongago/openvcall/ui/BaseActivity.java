...
import com.longlongago.openvcall.BuildConfig;
import com.longlongago.openvcall.model.CurrentUserSettings;
import com.longlongago.openvcall.model.EngineConfig;
import com.longlongago.openvcall.model.MyEngineEventHandler;
...
public abstract class BaseActivity extends AppCompatActivity {
    ...
    public boolean checkSelfPermission(String permission, int requestCode) {
        ...
        if (Manifest.permission.CAMERA.equals(permission)) {
            ((LLAApplication) getApplication()).initWorkerThread();
        }
        return true;
    }

    protected RtcEngine rtcEngine() {
        return ((LLAApplication) getApplication()).getWorkerThread().getRtcEngine();
    }

    protected final WorkerThread worker() {
        return ((LLAApplication) getApplication()).getWorkerThread();
    }

    protected final EngineConfig config() {
        return ((LLAApplication) getApplication()).getWorkerThread().getEngineConfig();
    }

    protected final MyEngineEventHandler event() {
        return ((LLAApplication) getApplication()).getWorkerThread().eventHandler();
    }
    ...
    protected CurrentUserSettings vSettings() {
        return LLAApplication.mVideoSettings;
    }
...
//        textVersion.setText(version);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent i = new Intent(BaseActivity.this, MenuActivity.class);
        startActivity(i);
    }
}
