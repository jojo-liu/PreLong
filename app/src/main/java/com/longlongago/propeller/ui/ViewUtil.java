package com.longlongago.propeller.ui;
...
public class ViewUtil {
    ...
    public static String composeVideoInfoString(Context context, VideoInfoData videoMetaData) {
        ...
        return videoMetaData.mWidth + "x" + videoMetaData.mHeight + ", "
                + context.getString(com.longlongago.openvcall.R.string.frame_rate_value_with_unit, videoMetaData.mFrameRate) + ", "
                + context.getString(com.longlongago.openvcall.R.string.bit_rate_value_with_unit, videoMetaData.mBitRate);
    }
}
