package com.longlongago.resideMenu.model;
...
/**
 * Created by Jojo on 29/07/2017.
 */

public class CircleAvatar extends android.support.v7.widget.AppCompatImageView {
    ...
    public CircleAvatar(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mBorderColor = a.getColor(index, getResources().getColor(R.color.colorPrimary));
        a.recycle();
        this.mReady = true;
